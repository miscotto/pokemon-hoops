...
const ROLE_POSITION_SYNERGY: Record<string, Record<string, number>> = {
  ...
  "Point Forward":      {"Small Forward": 1, "Point Guard": 1},
  ...
  "Offensive Hub":      { "Point Guard": 1, "Small Forward": 1, "Shooting Guard": 1 },
  "Shot Creator":       { "Shooting Guard": 2, "Small Forward": 1 },
  "Primary Scorer":     { "Shooting Guard": 2, "Small Forward": 1 },
  "Slasher":            { "Point Guard": 1, "Shooting Guard": 1, "Small Forward": 1 },
  "3-and-D Wing":       { "Small Forward": 2, "Shooting Guard": 1 },
  "Perimeter Stopper":  { "Shooting Guard": 2, "Small Forward": 1, "Center": -1 },
  "Defensive Big":      { "Center": 2, "Power Forward": 1, "Point Guard": -1 },
  "Glue Guy":           { "6th Man (Reserve)": 2, "Small Forward": 1 },
  // Decent fits (+1)
